    ...
    int64_t output_size)
{
    ...
    return sparse_tensor_product_cuda_forward(X1, mu_1, mu_1_offsets, X2, mu_2, mu_2_offsets, cg_coefficients, n_cg_coefficients,cg_offsets, mu_3, mu_3_offsets, output_size);
}
